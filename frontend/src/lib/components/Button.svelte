...
<button
  class="ants-btn ants-btn--{variant} ants-btn--{size}"
  {disabled}
...
<style>
  ...
  .ants-btn--primary:hover {
    background-color: var(--accent-default);
    box-shadow: var(--shadow-4);
  }

  .ants-btn--primary:active {
  ...
  .ants-btn--secondary:hover {
    background-color: var(--stroke-subtle);
    border-color: var(--stroke-default);
  }

  .ants-btn--secondary:active {
    background-color: var(--stroke-subtle);
    box-shadow: var(--shadow-0);
  }
  ...
  .ants-btn--danger:hover {
    background-color: rgb(196, 43, 43);
    box-shadow: var(--shadow-4);
  }

  .ants-btn--danger:active {
  ...
  .ants-btn--ghost:hover {
    background-color: var(--stroke-subtle);
  }

  .ants-btn--ghost:active {
    background-color: var(--stroke-subtle);
  }
  ...
  .ants-btn--outline:hover {
    background-color: var(--stroke-subtle);
    border-color: var(--stroke-strong);
  }

  .ants-btn--outline:active {
    background-color: var(--stroke-subtle);
  }
  ...
  .ants-btn--subtle:hover {
    background-color: var(--stroke-subtle);
    color: var(--text-primary);
  }

  .ants-btn--subtle:active {
    background-color: var(--stroke-subtle);
  }
</style>
